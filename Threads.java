...
class Threads extends Thread{
    ...
    Threads (String threadName, Socket connection, int no, int type) {
        // threadName = name;
    ...
    public void run(){
        ...
        else if (threadType == 1)
        {
            ...
            try{
                ...
                try {
                    while(true) {
                        new Threads("Server", listener.accept(),clientNum, 0).start();
        ...
        {
            System.out.println("ERRRORRR making threads: bad type");
        }
    }
    public void start () {
    ...
    public static void main(String args[]) throws Exception {
        ...
        Threads R2 = new Threads("Thread-2", requestSocket,1,1);
        R2.start();
    }
}
